...
A `LICENSE-memos` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [MemTensor/MemOS](https://github.com/MemTensor/MemOS), Copyright
2025 - Present MemTensor Research, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../memos-port/specs/SPEC-001-memos.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
